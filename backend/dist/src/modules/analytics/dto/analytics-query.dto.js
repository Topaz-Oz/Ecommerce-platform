...
], AnalyticsQueryDto.prototype, "sellerId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], AnalyticsQueryDto.prototype, "enterpriseId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Giới hạn (VD: top 5)', default: 5 }),
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.Matches)(/^(day|week|month)$/, { message: 'Unit must be day, week, or month' }),
    __metadata("design:type", String)
], AnalyticsQueryDto.prototype, "unit", void 0);
