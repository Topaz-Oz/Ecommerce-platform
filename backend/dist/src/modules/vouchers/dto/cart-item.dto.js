...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID của sản phẩm (Product)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CartItemDto.prototype, "productId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID của biến thể (ProductVariant)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CartItemDto.prototype, "variantId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID của người bán (Seller/Enterprise)' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Giá của 1 sản phẩm (tại thời điểm thêm vào giỏ)' }),
